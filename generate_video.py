...
YT_EMAIL = os.getenv("YOUTUBE_EMAIL", "")
YT_PASSWORD = os.getenv("YOUTUBE_PASSWORD", "")
...
async def login(page):
    ...
    await page.goto("https://accounts.google.com/signin", wait_until="networkidle", timeout=30_000)
    ...
    # Dismiss any "stay signed in" / recovery prompts
    for selector in [
    ...
    print("  → login done, navigating to YouTube...")
...
async def main():
    ...
    async with async_playwright() as p:
        ...
        if YT_EMAIL and YT_PASSWORD:
            ...
            print("  WARNING: no credentials set — may get bot-blocked")
